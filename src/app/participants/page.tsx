                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
                                <div className="flex items-center gap-4 mb-4">
                                    {/*<Image/>* add an image*/}
                                    <h3 className="text-2xl font-bold text-gray-900">Participating Country</h3>
                                </div>
                                <p className="text-gray-600">Lorom ipsum</p>
                                <div className="mt-4 text-sm text-gray-500">Dolor sit amet</div>
                            </div>
                        </div>
